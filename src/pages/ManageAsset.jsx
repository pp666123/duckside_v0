...
const urlPostRecent = 'https://still-scrubland-65207.herokuapp.com/asset/recent';
const urlPostCreate = 'https://still-scrubland-65207.herokuapp.com/asset/create';
const urlPutUpdate = 'https://still-scrubland-65207.herokuapp.com/asset/update';
const urlDelete = 'https://still-scrubland-65207.herokuapp.com/asset/delete';
const urlPostInventory = 'https://still-scrubland-65207.herokuapp.com/transaction/inventory';
const urlPostMarketValue = 'https://still-scrubland-65207.herokuapp.com/marketInfo/inventory';
