...
let GameRoomMain = (props) => {
    ...
    let putInRoom = async(e) => {
        ...
        await Axios.put('https://still-scrubland-65207.herokuapp.com/acc_furn/placing',{
    ...
    let putInStorage = async(e) => {
        console.log(e.currentTarget.dataset.furnid);
        await Axios.put('https://still-scrubland-65207.herokuapp.com/acc_furn/takeBack',{
            acc_email:localStorage.getItem("loginState"),
            furn_id: e.currentTarget.dataset.furnid
        })
        // setupToDate(false)
    ...
    useEffect( () => {
        Axios.post('https://still-scrubland-65207.herokuapp.com/acc_furn/storageList', {
           acc_email:localStorage.getItem("loginState"),
        ...
        Axios.post('https://still-scrubland-65207.herokuapp.com/acc_furn/roomList', {
           acc_email:localStorage.getItem("loginState"),
